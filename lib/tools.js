...
export const TOOL_CATALOG = [
    { key: 'digitalKhata',      label: 'Digital Khata',          href: '/dashboard/accounting' },
    { key: 'jobApplicationInfo', label: 'Job Application Info',  href: '/dashboard/job-application' },
    ...
    { key: 'idCard',            label: 'ID Card Maker',          href: '/dashboard/id-card' },
